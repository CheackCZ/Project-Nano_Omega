...
public class HorniCast_JPanel extends JPanel {
	...
	//Buttons that shows if the spinning kick was done or not by the red competitor
	   ...
	   //JRadioButton that shows if the red competitor did the spinning kick in the first round or not
		...
		povinnaOtockaCerveny1.setToolTipText("Povinná otoèka èervený, 1. kolo");
		povinnaOtockaCerveny1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (kopnuto == true) {
					...
					povinnaOtockaCerveny1.setIcon(new ImageIcon("povinnaOtocka_selected_icon-red.png"));
					window.CervenyZavodnik.getStatistiky().PotvrzeniOtockyCerveny();
				}
				kopnuto = true;
			}
		}); 
		povinnaOtockaCerveny1.setIcon(new ImageIcon("povinnaOtocka_unselected_icon.png"));
	   ...
	   //JRadioButton that shows if the red competitor did the spinning kick or in the second round not
		...
		povinnaOtockaCerveny2.setToolTipText("Povinná otoèka èervený, 2. kolo");
		povinnaOtockaCerveny2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				povinnaOtockaCerveny2.setIcon(new ImageIcon("povinnaOtocka_selected_icon-red.png"));
			}
		});
		povinnaOtockaCerveny2.setIcon(new ImageIcon("povinnaOtocka_unselected_icon.png"));
	 ...
	 //Buttons that shows if the spinning kick was done or not by the red blue competitor
	   ...
	   //JRadioButton that shows if the blue competitor did the spinning kick in the first round or not
		...
		povinnaOtockaModry1.setToolTipText("Povinná otoèka modrý, 1. kolo");
		povinnaOtockaModry1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (kopnuto == true) {
					...
					povinnaOtockaModry1.setIcon(new ImageIcon("povinnaOtocka_selected_icon-blue.png"));
					window.ModryZavodnik.getStatistiky().PotvrzeniOtockyModry();	
				}
				kopnuto = true;
			}
		});
		povinnaOtockaModry1.setIcon(new ImageIcon("povinnaOtocka_unselected_icon.png"));
	   ...
	   //JRadioButton that shows if the blue competitor did the spinning kick in the second round or not
		...
		povinnaOtockaModry2.setToolTipText("Povinná otoèka modrý, 2. kolo");
		povinnaOtockaModry2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				povinnaOtockaModry2.setIcon(new ImageIcon("povinnaOtocka_selected_icon-blue.png"));
			}
		});
		povinnaOtockaModry2.setIcon(new ImageIcon("povinnaOtocka_unselected_icon.png"));
